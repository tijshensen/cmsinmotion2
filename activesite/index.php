<?php
	...
	if ($_GET['url'] == "sitemap.xml") {
		...
		if (file_exists("../cms/renders/sitemap.data")) {
		
		    header("Content-Type: text/xml");
			$fetch = file_get_contents("../cms/renders/sitemap.data");
		    ...
		    if (file_exists("../cms/renders/sitemap.data")) {
    			...
    			$fetch = "<html><head><title>404 - File not found</title></head><body>404 - this file was not found on the server</body></html>";
