package ro.fwd{
	...
	public class SoundScreenEvent extends Event {
		...
		public function SoundScreenEvent(pType:String, text:String=null, number:Number = 0, pBubbles:Boolean=false, pCancelable:Boolean=false) {
			this._text = text;
			this._number = number;
		...
		override public function clone():Event {
			return new SoundScreenEvent(type, _text, _number, bubbles, cancelable);
		}
