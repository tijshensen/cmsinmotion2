package ro.fwd{
	...
	public class Main extends MovieClip{
		...
		private function init(){
			 ...
			 this._sourcePath_str = String(LoaderInfo(this.root.loaderInfo).parameters.sourcePath);
			 this._volume = Number(LoaderInfo(this.root.loaderInfo).parameters.volume);
			 this._autoPlay_bl = LoaderInfo(this.root.loaderInfo).parameters.autoPlay == "true" ? true : false;
			...
			//_soundScreen = new SoundScreen("http://www.webdesign-flash.ro/ht/ad/1.mp3", .2,  true, true);
			_self._soundScreen = new SoundScreen(_self._sourcePath_str, _self._volume, _self._autoPlay_bl, _self._loop_bl);
