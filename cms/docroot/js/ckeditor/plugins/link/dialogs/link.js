			...
			contents: [
				...
				elements: [
					...
					children: [
						...
						children: [
							...
							commit: function( data ) {
								if ( !data.url )
									data.url = {};
								if (data.url.protocol == "internal") { data.url.protocol = "" } else {
					...
					children: [
						...
						setup: function( data ) {
							if ( !this.getDialog().getContentElement( 'internal', 'linkType' ) )
								this.getElement().show();
